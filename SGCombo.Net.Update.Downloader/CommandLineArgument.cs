...
// size=100 /height:'400' -config "./test 1" --debug 




namespace SGCombo.Net.CommandLineHelper
{
    public class CommandLineArguments
    {
        ...
        private static CommandLineArguments ins = null;

        public static bool isCommadLineExist()
        {
        ...
        public static void OnStart(string[] Args){
            ins = new CommandLineArguments(Args);
        }
        ...
        protected CommandLineArguments(string[] Args)
        {
            ...
            {
                Console.WriteLine("Invalid argumentLine"); 
            }
        }
